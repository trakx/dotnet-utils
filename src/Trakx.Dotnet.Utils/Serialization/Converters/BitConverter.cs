...
namespace Trakx.Dotnet.Utils.Serialization.Converters
{
    public static class BitConverter
    {
        ...
        {
            if (bytes.Count() != 16) throw new ArgumentOutOfRangeException("A decimal must be created from exactly 16 bytes");
